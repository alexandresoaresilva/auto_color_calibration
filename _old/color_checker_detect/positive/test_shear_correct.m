...
addpath('E:\code\GitHub\auto_color_calibration\checker_imgs');
addpath('E:\code\GitHub\auto_color_calibration\checker_imgs\colorCalTrouble\fails_to_detect_any_patches');
...
%resize to 640x480
I = uint8(convn(I,filter_int(15),'same'));
