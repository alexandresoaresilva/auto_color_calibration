clear, clc
close all;
color_folder_path = 'D:\Users\alexa\Documents\GitHub\MATLABrealsense\App_SR300_Beta1\colorcalibration\color_checker_detect\positive\'
color_pic = [color_folder_path, 'checker_iphone.png'];
I=imread('gray_13.png');
I=max(double(I),0);
I=I/max(I(:));
I_cor = imread(color_pic);
